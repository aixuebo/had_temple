...
public class StringUtil {
	...
	public static String trimCharSequence(CharSequence value) {
		return trimCharSequence(value, "");
	}
	...
	public static String formatDecimal(long decimalLong) {
		DecimalFormat df1 = new DecimalFormat("#,###.00");
		return df1
				.format(div(String.valueOf(decimalLong), "100").doubleValue());
	}
	...
	public static BigDecimal div(String value1, String value2) {
		return new BigDecimal(value1).divide(new BigDecimal(value2), 2,
	...
	public static String parseLineForString(String line, String key,
			String separator, String defaultStr) {
		...
		if (!"".equals(separator)) {
			...
			String str = line.substring(indexBegin + key.length(), indexEnd)
					.trim();
			return str;
		} else {
	...
	public static long parseLineForLong(String line, String key,
			String separator) {
		return Long.parseLong(parseLineForString(line, key, separator, "-1"));
	}

	public static int parseLineForInteger(String line, String key,
			String separator) {
	 ...
	 * 期初sqoop中字符串的'
	 */
	public static String replaceSqoop(String value) {
		return value.replaceAll("'", "");
	}

	/**
	 * @param formatMessage
	 *            /data/coohua/logs/cdp/{0}/data/{1}
	 */
	public static String formatMessage(String formatMessage, Object... arrs) {
		return trim(MessageFormat.format(formatMessage, arrs));
	}

	public static <T> String mkString(List<T> list,String prefix,String suffer,String sep){
	...
	public static <T> String mkString(List<T> list,String sep){
		return mkString(list,"","",sep);
	}
